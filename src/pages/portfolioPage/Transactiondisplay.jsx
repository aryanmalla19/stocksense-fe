...
import Pagination from "../stockPage/Pagination";
...
const Transactiondisplay = ({
  ...
  return (
    <>
      <div
        className={`outlet-container rounded-md p-8 transition-colors duration-300 overflow-y-scroll scrollbar-hidden h-[290px] 
    ${
      theme === "dark"
      ...
      >
        <div className="grid grid-cols-7 bg-purple-button  text-white font-semibold p-2 rounded-md sticky top-0 z-10">
